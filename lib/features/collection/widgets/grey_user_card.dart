...
class UserGreyCard extends StatelessWidget with HelperFunctions {
  final String userName, gender, userAdrs, mrnNumber, age, phone, lat, lng;
                  ...
                  Row(
                    children: [
                      ...
                      InkWell(
                        onTap: () async {
                          await openGoogleMap(
                              lat: lat, lng: lng, address: userAdrs);
                        },
                        child: IconText(
  ...
  String timeDetails(int timeInMin) {
    if (timeInMins < 60) {
